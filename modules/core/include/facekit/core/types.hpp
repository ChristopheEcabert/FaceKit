 ...
 */
#define SPECIALIZE_TYPE_AND_ENUM(TYPE, ENUM)  \
  template<>                                  \
...
/** Int8 Specialization */
SPECIALIZE_TYPE_AND_ENUM(int8_t, DataType::kInt8);
/** UInt8 Specialization */
SPECIALIZE_TYPE_AND_ENUM(uint8_t, DataType::kUInt8);
/** Int16 Specialization */
SPECIALIZE_TYPE_AND_ENUM(int16_t, DataType::kInt16);
/** UInt16 Specialization */
SPECIALIZE_TYPE_AND_ENUM(uint16_t, DataType::kUInt16);
/** Int32 Specialization */
SPECIALIZE_TYPE_AND_ENUM(int32_t, DataType::kInt32);
/** UInt8 Specialization */
SPECIALIZE_TYPE_AND_ENUM(uint32_t, DataType::kUInt32);
/** Float Specialization */
SPECIALIZE_TYPE_AND_ENUM(float, DataType::kFloat);
/** Double Specialization */
SPECIALIZE_TYPE_AND_ENUM(double, DataType::kDouble);
/** size_t Specialization */
SPECIALIZE_TYPE_AND_ENUM(size_t, DataType::kSize_t);
/** bool Specialization */
SPECIALIZE_TYPE_AND_ENUM(bool, DataType::kBool);

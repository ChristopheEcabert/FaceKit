 ...
 */
template<typename T>
WeakProjection<T>::WeakProjection(const T focal,
                                  const T width,
                                  const T height) {
  this->focal_ = focal;
 ...
 */
template<typename T>
void WeakProjection<T>::ToVector(T* vector) const {
 ...
 */
template<typename T>
void WeakProjection<T>::FromVector(const T* vector) {
 ...
 */
template<typename T>
void WeakProjection<T>::operator()(const Point3& pts,
                                   Point2* proj) const {
  // Project pts
 ...
 */
template<typename T>
void WeakProjection<T>::operator()(const std::vector<Point3>& pts,
                                   std::vector<Point2>* proj) const {
  // Init output
...
/** Float */
template class WeakProjection<float>;
/** Double */
template class WeakProjection<double>;

...
function(_protobuf_find_libraries name filename extra_path)
  if(${name}_LIBRARIES)
  ...
  elseif(${name}_LIBRARY)
    ...
    find_library(${name}_LIBRARY_RELEASE
      NAMES ${filename}
      PATHS ${Protobuf_SRC_ROOT_FOLDER}/vsprojects/${_PROTOBUF_ARCH_DIR}Release ${extra_path})
    mark_as_advanced(${name}_LIBRARY_RELEASE)

    find_library(${name}_LIBRARY_DEBUG
      NAMES ${filename}d ${filename}
      PATHS ${Protobuf_SRC_ROOT_FOLDER}/vsprojects/${_PROTOBUF_ARCH_DIR}Debug ${extra_path})
...
# Find root installation folder if `protoc` has been found
IF(Protobuf_PROTOC_EXECUTABLE)
  GET_FILENAME_COMPONENT(Protobuf_PROTOC_DIR ${Protobuf_PROTOC_EXECUTABLE} DIRECTORY)
...
# The Protobuf library
_protobuf_find_libraries(Protobuf protobuf ${Protobuf_EXTRA_LIBRARIES_DIR})
#DOC "The Google Protocol Buffers RELEASE Library"

_protobuf_find_libraries(Protobuf_LITE protobuf-lite ${Protobuf_EXTRA_LIBRARIES_DIR})

# The Protobuf Protoc Library
_protobuf_find_libraries(Protobuf_PROTOC protoc ${Protobuf_EXTRA_LIBRARIES_DIR})
...
find_path(Protobuf_INCLUDE_DIR
    ...
    PATHS ${Protobuf_SRC_ROOT_FOLDER}/src ${Protobuf_EXTRA_INCLUDE_DIR}
)

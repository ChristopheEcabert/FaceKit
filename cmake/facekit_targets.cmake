...
macro(FACEKIT_ADD_TEST _name _exename)
    ...
    add_executable(${_exename} ${FACEKIT_ADD_TEST_FILES})
    ...
    # Link extra library
    target_link_libraries(${_exename} ${FACEKIT_ADD_TEST_LINK_WITH} gtest gmock ${CLANG_LIBRARIES})
    # Only link if needed
    ...
    # Register new text
    add_test(NAME ${_name} COMMAND ${_exename} ${FACEKIT_ADD_TEST_ARGUMENTS} WORKING_DIRECTORY ${FACEKIT_ADD_TEST_WORKING_DIR})
...
macro(FACEKIT_ADD_EXAMPLE _name)
    ...
    add_executable(${_name} ${FACEKIT_ADD_EXAMPLE_FILES})
    target_link_libraries(${_name} ${FACEKIT_ADD_EXAMPLE_LINK_WITH} ${CLANG_LIBRARIES})
    if(WIN32 AND MSVC)
      set_target_properties(${_name} PROPERTIES DEBUG_OUTPUT_NAME ${_name}${CMAKE_DEBUG_POSTFIX}
                                                RELEASE_OUTPUT_NAME ${_name}${CMAKE_RELEASE_POSTFIX})
